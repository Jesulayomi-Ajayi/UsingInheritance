...
{
    public class BasePlusCommissionEmployeeUsingInheritanceTest
    {
        //public static void Main(string[] args)
        //{
        //    BasePlusCommissionEmployeeUsingInheritance employee = new BasePlusCommissionEmployeeUsingInheritance("Bob", "Lewis", "333-33-3333", 5000.00M, .04M, 300.00M);
        ...
        //    Console.WriteLine("earnings: {0:C}", employee.EmployeeInfo());
